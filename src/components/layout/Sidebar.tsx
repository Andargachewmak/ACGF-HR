...
const NAV = [
  {
    ...
    items: [
      ...
      { path: '/employees', label: 'Employees', icon: <UsersIcon />, badge: 248 },
      { path: '/recruitment', label: 'Recruitment', icon: <BriefcaseIcon />, badge: 12 },
    ],
  },
  {
    group: 'Operations',
      ...
      <div className="border-t border-white/7 p-3 relative">
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            ...
            <p className="text-xs text-slate-600 truncate">{user?.role ?? 'Member'}</p>
          </div>
...
function BarIcon() {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
}
function DocIcon() {
